...
% Forest.T: Trees
 ...
 Forest.P.Dimension=size(Ranges,1);%dim;                 % The dimension of the problem domain
 ...
 for u=1:size(Ranges,1)
     Forest.T(:,u)=random('unif', Ranges(u,1), Ranges(u,2), Forest.P.area_limit,1); 
 end
